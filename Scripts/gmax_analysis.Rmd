...
```{r source_functions_&_libraries, echo=FALSE, results='hide', message=FALSE}
...
```{r read_in_cov_matrices_to_list, echo=TRUE, eval=FALSE}
# read_matrices&means
...
```{r read_in_matrix_list, echo=TRUE, results='asis'}
setwd( "..//Data" )
...
```{r tabulate_data_for_tables, echo=FALSE}
...
```{r cov_pairs_plot, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.height=7, fig.height=7}
...
```{r model_selection_for_END, echo=FALSE, results='hide', message=FALSE, fig.keep='none'}
...
```{r END_results, results='hide', fig.height=4, fig.width=4, echo=FALSE}
...
```{r comparing_nD_scaling_options, echo=FALSE, fig.keep='last', message=FALSE}
...
```{r average_evolvability_model_selection, echo=FALSE, results='hide', message=FALSE, fig.keep='none'}
...
```{r model_selection_for_eveness, echo=FALSE, results='hide', message=FALSE, fig.keep='none'}
...
```{r read_in_correlation_matrices, echo=TRUE, eval=FALSE}
...
```{r read_in_cor_matrix_list, echo=TRUE, results='asis'}
...
```{r data_hygiene_cor_matrices, echo=FALSE, results='hide', message=FALSE, fig.keep='none'}
...
```{r tabulate_descriptive_stats, echo=FALSE}
...
```{r cor_pairs_plot, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.height=7, fig.height=7}
...
```{r more_supplementary_plots, message=FALSE, echo=FALSE, fig.keep='high'}
par( mfrow=c(1,2) )
...
```{r model_selection_using_REV, echo=FALSE, results='hide', message=FALSE, fig.keep='none'}
...
```{r REV_results, results='hide', fig.height=4, fig.width=4, echo=FALSE}
# REV plot
...
```{r model_selection_for_Eigenvalue_Variance, echo=FALSE, results='hide', message=FALSE, fig.keep='none'}
...
```{r Eigenvalue_variance_results, results='hide', echo=FALSE, fig.height=4, fig.width=4}
...
```{r model_selection_for_Eveness, echo=FALSE, results='hide', fig.keep='none', message=FALSE}
...
```{r Eveness_results, results='hide', echo=FALSE, fig.height=4, fig.width=4}
Evenfixed <- apply( Even.estimates, 2, mean )
...
```{r ouputting_plots_for_the_MS, eval=FALSE, echo=TRUE}
